...
demoDirs.forEach(function (dir) {
    ...
    files.forEach(function (file) {
        ...
        var href = base + 'zh-cn/g6/2.x/demo/' + category + '/' + name + '.html';
        var demo = {
            screenshot: meta.screenshot || join(assets + '/dist/' + pkg.version + '/g6/2.x/', category + '/' + name + '.png'),
            // screenshotDark: join(assets + '/dist/' + pkg.version + '/g6/2.x/', category + '/' + name + '-dark.png'),
            href,
            index: index,
            name: name,
            category: category,
