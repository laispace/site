...
demoDirs.forEach(function (dir) {
    ...
    files.forEach(function (file) {
        ...
        var demo = {
            screenshot: meta.screenshot || join(assets + '/dist/' + pkg.version + '/l7/1.x/', category + '/' + name + '.png'),
            naked: join(assets + '/dist/' + pkg.version + '/l7/1.x/', category + '/' + name + '.html'),
            // screenshotDark: join(assets + '/dist/' + pkg.version + '/l7/1.x/', category + '/' + name + '-dark.png'),
            href: href,
            index: index,
            name: name,
            category: category,
