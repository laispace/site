...
module.exports = {
    url: {
        ...
        'g2-plugin-slider': 'https://gw.alipayobjects.com/os/antv/assets/g2-plugin-slider/2.0.4/g2-plugin-slider.js',
        ...
        f2: 'https://gw.alipayobjects.com/os/antv/assets/f2/3.2.0/f2.min.js',
        'f2-all': 'https://gw.alipayobjects.com/os/antv/assets/f2/3.2.0/f2-all.min.js',
